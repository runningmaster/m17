...
func (h *handler) prepareAPI() *handler {
	...
	h.api = map[string]http.Handler{
		...
		"POST /get-spec-inf-list-by-class-atc": pipe.Join(mdware.Exec(exec(h, getSpecINFListByClassATC))),
		"POST /get-spec-inf-list-by-class-nfc": pipe.Join(mdware.Exec(exec(h, getSpecINFListByClassNFC))),
		"POST /get-spec-inf-list-by-class-fsc": pipe.Join(mdware.Exec(exec(h, getSpecINFListByClassFSC))),
		"POST /get-spec-inf-list-by-class-bfc": pipe.Join(mdware.Exec(exec(h, getSpecINFListByClassBFC))),
		"POST /get-spec-inf-list-by-class-cfc": pipe.Join(mdware.Exec(exec(h, getSpecINFListByClassCFC))),
		"POST /get-spec-inf-list-by-class-mpc": pipe.Join(mdware.Exec(exec(h, getSpecINFListByClassMPC))),
		"POST /get-spec-inf-list-by-class-csc": pipe.Join(mdware.Exec(exec(h, getSpecINFListByClassCSC))),
		"POST /get-spec-inf-list-by-class-icd": pipe.Join(mdware.Exec(exec(h, getSpecINFListByClassICD))),
		"POST /get-spec-inf-list-by-inn":       pipe.Join(mdware.Exec(exec(h, getSpecINFListByINN))),
		"POST /get-spec-inf-list-by-maker":     pipe.Join(mdware.Exec(exec(h, getSpecINFListByMaker))),
		"POST /get-spec-inf-list-by-drug":      pipe.Join(mdware.Exec(exec(h, getSpecINFListByDrug))),
		"POST /get-spec-inf-list-by-spec-act":  pipe.Join(mdware.Exec(exec(h, getSpecINFListBySpecACT))),
		"POST /get-spec-inf-list-by-spec-dec":  pipe.Join(mdware.Exec(exec(h, getSpecINFListBySpecDEC))),
		...
		"POST /get-spec-dec-list-by-class-atc": pipe.Join(mdware.Exec(exec(h, getSpecDECListByClassATC))),
		"POST /get-spec-dec-list-by-class-nfc": pipe.Join(mdware.Exec(exec(h, getSpecDECListByClassNFC))),
		"POST /get-spec-dec-list-by-class-fsc": pipe.Join(mdware.Exec(exec(h, getSpecDECListByClassFSC))),
		"POST /get-spec-dec-list-by-class-bfc": pipe.Join(mdware.Exec(exec(h, getSpecDECListByClassBFC))),
		"POST /get-spec-dec-list-by-class-cfc": pipe.Join(mdware.Exec(exec(h, getSpecDECListByClassCFC))),
		"POST /get-spec-dec-list-by-class-mpc": pipe.Join(mdware.Exec(exec(h, getSpecDECListByClassMPC))),
		"POST /get-spec-dec-list-by-class-csc": pipe.Join(mdware.Exec(exec(h, getSpecDECListByClassCSC))),
		"POST /get-spec-dec-list-by-class-icd": pipe.Join(mdware.Exec(exec(h, getSpecDECListByClassICD))),
		"POST /get-spec-dec-list-by-inn":       pipe.Join(mdware.Exec(exec(h, getSpecDECListByINN))),
		"POST /get-spec-dec-list-by-maker":     pipe.Join(mdware.Exec(exec(h, getSpecDECListByMaker))),
		"POST /get-spec-dec-list-by-drug":      pipe.Join(mdware.Exec(exec(h, getSpecDECListByDrug))),
		"POST /get-spec-dec-list-by-spec-act":  pipe.Join(mdware.Exec(exec(h, getSpecDECListBySpecACT))),
		"POST /get-spec-dec-list-by-spec-inf":  pipe.Join(mdware.Exec(exec(h, getSpecDECListBySpecINF))),
